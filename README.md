...
A full featured php client for the Google Analytics Measurment Protocol API. Build upon the shoulders of the great [Guzzle](http://docs.guzzlephp.org/en/latest/). This library is currently in development but will be tagged 1.0 mid december 2013 when all features are implemented.
